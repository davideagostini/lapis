...
import lapisnet.it.adapter.EventListHomeAdapter;
...
public class HomeEventListFragment extends Fragment {
	...
	private EventListHomeAdapter mAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if(savedInstanceState!= null) {
			...
			mSelectCategory = (String) savedInstanceState.getSerializable("categoria");
			mAdapter = new EventListHomeAdapter(getActivity(), mEventList);
	...
	public void onSaveInstanceState(Bundle outState) {
		...
		outState.putSerializable("categoria", mSelectCategory);
	}
	...
	class LoadEvent extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			String json = jsonParser.makeHttpRequest(Constant.URL_EVIDENZA, "GET", params);
				...
				if (mItem != null) {
					for (int i = 0; i < mItem.length(); i++) {
						...
						if(c.has("num_pages"))
							...
							String thumb = c.getString(Constant.EVENT_THUMB);

							Event item = new Event(id, titolo, type, day, month, luogo, cat, thumb);
							mEventList.add(item);
						}
	...
	public void showDialogCategory() {
		...
		filter.setTargetFragment(HomeEventListFragment.this, 1);
	...
	private void showDialogDate() {
		...
		date.setTargetFragment(HomeEventListFragment.this, 0);
	...
	public class EndlessScrollListener implements OnScrollListener {
		...
		private int mVisibleTreshold = 1;
		...
		public void onScrollStateChanged(AbsListView view, int scrollState) {
			if(scrollState == SCROLL_STATE_IDLE) {
				if(mList.getLastVisiblePosition() >= mList.getCount() - mVisibleTreshold) {
